<div class="row" >
	...
	<div class="col-4">
		<div class="form-group">
			...
			{!! Form::text('repLegal', null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Ingrese el nombre','data-toggle="tooltip" data-placement="top" title="Ingrese nombre del asesor juridico!"','data-validation'=>'required']) !!}
			<div class="help-block with-errors"></div> 
		</div>
	</div>
	...
	<div class="col-4">
			<div class="form-group">
				...
				<input type="date" id="fechaAltaEmpresa" name="fechaAltaEmpresa" class="form-control form-control-sm " data-toggle="tooltip" data-placement="top" title="Ingrese la fecha de adscripción de la empresa ante notario!" required>
	...
	<div class="col-4">
			...
			<div class="col">
				...
				{!! Form::text('homo1', null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Ingrese el R.F.C.','data-validation'=>'required' ,'data-validation-length'=>'8','data-validation-error-msg'=>'RFC inválido' ,'data-toggle="tooltip" data-placement="top" title="El campo HOMO clave se genera automáticamente , verifique si esta correcto!"','required']) !!}
			</div>
		</div>
	</div>
	</div>
