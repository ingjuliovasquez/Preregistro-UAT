...
<body class="error-notf">
        <div>
                <div class="error-body text-center">
                    <h1 class="not-found">403</h1>
                    <h3 class="text-uppercase">NO CUENTA CON LOS PERMISOS PARA ACCEDER</h3>
                    <p class="text-uppercase text-muted">>PORFAVOR COMUNÍQUESE A LA DIRECCIÓN DEL CENTRO DE INFORMACIÓN E INFRAESTRUCTURA TECNOLÓGICA.</p>
